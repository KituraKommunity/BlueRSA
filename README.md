<p align="center">
    ...
    <a href="https://travis-ci.org/KituraKommunity/BlueRSA">
    <img src="https://travis-ci.org/KituraKommunity/BlueRSA.svg?branch=master" alt="Build Status - Master">
    </a>
...
```
	dependencies: [
		.Package(url: "https://github.com/KituraKommunity/BlueRSA", majorVersion: <majorVersion>, minor: <minor>)
	]
```
...
```
	github "KituraKommunity/BlueRSA" ~> <majorVersion>.<minor>
```
...
This library is licensed under Apache 2.0. Full license text is available in [LICENSE](https://github.com/KituraKommunity/BlueRSA/blob/master/LICENSE).
